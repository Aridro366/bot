...
async def on_member_join(member):
    try:
        ...
        welcome_channel = member.guild.get_channel(1443404889894948974)  # CHANGE TO YOUR CHANNEL ID

        gif_url = "https://tenor.com/en-GB/view/welcome-gif-2777370119495394068"  # Your GIF

        embed = discord.Embed(
            title=f"Welcome {member.name}! 🎉",
            description=(
                f"Welcome to **{member.guild.name}**! We're happy to have you here ❤️\n\n"
                "✨ **Thanks for joining our premium digital marketplace.**\n\n"
                "• ✨ Cheap Prices\n"
                "• ⚡ Instant Delivery\n"
        ...
        dm_embed = discord.Embed(
            ...
            description=(
                ...
                "If you ever need any help or wish to make a purchase, just ping staff or open a ticket.\n\n"
                "Enjoy your stay ❤️"
            ),
            color=discord.Color.blue()
        )
